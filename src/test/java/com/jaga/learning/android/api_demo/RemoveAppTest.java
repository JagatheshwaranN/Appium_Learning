...
public class RemoveAppTest extends BaseTest {

    @Test
    public void removeAppTest() throws URISyntaxException, InterruptedException, MalformedURLException {
        ...
        Thread.sleep(2000);
        driver.removeApp("io.appium.android.apis", new AndroidRemoveApplicationOptions().withKeepDataDisabled());
